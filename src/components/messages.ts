export const labels: Record<string, string> = {
  clicks: 'label.clicks',
  scroll: 'label.scroll',
  selectedPage: 'label.selected-page',
  screenWidth: 'label.screen-width',
  selectPage: 'label.select-page',
  clone: 'label.clone',
  cloneBoard: 'label.clone-board',
  board: 'label.board',
  components: 'label.components',
  preview: 'label.preview',
  addRow: 'label.add-row',
  addColumn: 'label.add-column',
  removeRow: 'label.remove-row',
  moveRowUp: 'label.move-row-up',
  moveRowDown: 'label.move-row-down',
  percentile: 'label.percentile',
  median: 'label.median',
  topWeekday: 'label.top-weekday',
  topDate: 'label.top-date',
  earliestDate: 'label.earliest-date',
  latestDate: 'label.latest-date',
  linkedIds: 'label.linked-ids',
  lightTheme: 'label.light-theme',
  darkTheme: 'label.dark-theme',
  manageTeams: 'label.manage-teams',
  copyUrl: 'label.copy-url',
  strictMask: 'label.strict-mask',
  moderateMask: 'label.moderate-mask',
  heatmapSampleRate: 'label.heatmap-sample-rate',
  replaySampleRate: 'label.replay-sample-rate',
  minutesCount: 'label.minutes-count',
  propertySelect: 'label.property-select',
  valueSelect: 'label.value-select',
  ok: 'label.ok',
...
export const messages: Record<string, string> = {
  heatmapDescription: 'message.heatmap-description',
  heatmapLoading: 'message.heatmap-loading',
  heatmapNoClickData: 'message.heatmap-no-click-data',
  heatmapNoScrollData: 'message.heatmap-no-scroll-data',
  heatmapChoosePage: 'message.heatmap-choose-page',
  heatmapRecordedWidth: 'message.heatmap-recorded-width',
  heatmapGroupedWidths: 'message.heatmap-grouped-widths',
  heatmapClickSummary: 'message.heatmap-click-summary',
  heatmapScrollSummary: 'message.heatmap-scroll-summary',
  heatmapScrollTooltip: 'message.heatmap-scroll-tooltip',
  heatmapScrollBand: 'message.heatmap-scroll-band',
  heatmapPageSummary: 'message.heatmap-page-summary',
  loadingOptions: 'message.loading-options',
  noSavedItemsFound: 'message.no-saved-items-found',
  unknownComponent: 'message.unknown-component',
  funnelUnavailable: 'message.funnel-unavailable',
  goalUnavailable: 'message.goal-unavailable',
  averageOrderValueDescription: 'message.average-order-value-description',
  averageRevenuePerUserDescription: 'message.average-revenue-per-user-description',
  error: 'message.error',
  saved: 'message.saved',
